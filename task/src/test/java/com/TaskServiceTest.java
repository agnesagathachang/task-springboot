...
// Task task = new Task("Task 1", "Description", "TODO");
...
// tasks.add(new Task("Task 1", "Description 1", "TODO"));
// tasks.add(new Task("Task 2", "Description 2", "IN_PROGRESS"));
...
// // Similar tests for getTasksByStatus, updateTask, and deleteTask methods
// }
